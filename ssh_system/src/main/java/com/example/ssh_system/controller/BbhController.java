package com.example.ssh_system.controller;

import com.example.ssh_system.entity.*;
import com.example.ssh_system.mapper.*;
...
//        request.getSession().setAttribute("user", user);
        ...
        return "system/find-student-list";
    }
